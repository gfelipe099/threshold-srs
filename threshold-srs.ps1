...
# threshold-srs.ps1 file
# System Readiness for Servers
# For Microsoft Windows Server 2016 x64
#
Clear-Host
...
[System.Windows.Forms.Application]::EnableVisualStyles()
    If (!([Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]'Administrator')) {
        ...
        No {
            Switch ([System.Windows.MessageBox]::Show("This script cannot be executed without Administrator privileges.", "threshold-srs", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Error)) {
            OK {
                Exit
            }
            }
...
${threshold-srs}                                                = New-Object System.Windows.Forms.Form
${threshold-srs}.ClientSize                                     = New-Object System.Drawing.Point(1050,700)
${threshold-srs}.Text                                           = "System Readiness for Servers"
${threshold-srs}.TopMost                                        = $false
...
${ProgramsSetup_Install_Bleachbit}.Location                     = New-Object System.Drawing.Point(20,135)
...
${ProgramsSetup_Uninstall_Chocolatey}.Location                  = New-Object System.Drawing.Point(20,190)
...
${ProgramsSetup_CheckForUpdates_Chocolatey}.Location            = New-Object System.Drawing.Point(20,245)
...
${ThirdpartyContainer_Sconfig}                                  = New-Object System.Windows.Forms.Button
${ThirdpartyContainer_Sconfig}.Text                             = "Open Windows Server CLI sconfig"
${ThirdpartyContainer_Sconfig}.AutoSize                         = $true
${ThirdpartyContainer_Sconfig}.Location                         = New-Object System.Drawing.Point(570,520)
${ThirdpartyContainer_Sconfig}.Font                             = New-Object System.Drawing.Font('Microsoft Sans Serif',20)
...
${ProgramsSetup_Uninstall_Chocolatey}.Add_Click({
    Write-Warning "Chocolatey will be uninstalled within 10 seconds..."
    Start-Sleep 5
...
if (${OsEdition} -ne "${validatedOsEdition}") {
    ${WShell}.Popup("The OS edition you are using is not validated to use with this script. You need to use ${validatedOsEdition}, and you are using: ${OsEdition}.",0,"$(${threshold-srs}.Text)",0x0)
    Exit
}

if (${OsVersion} -ne "${validatedOsVersion}") {
    ${WShell}.Popup("Your version of Windows is not validated on this script. You need to use ${validatedOsVersion}, and you are using ${OsVersion}.",0,"$(${threshold-srs}.Text)",0x0)
    Exit
}

[void]${threshold-srs}.ShowDialog()
